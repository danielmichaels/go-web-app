...
const (
	...
	classTopbar   = "flex items-center justify-between gap-4 border-b border-neutral-200 pb-4 dark:border-neutral-800"
	classBrand    = "font-semibold tracking-tight no-underline"
	classNavLink  = "ml-4 text-sm text-neutral-500 no-underline hover:text-accent dark:text-neutral-400"
	classSection  = "flex flex-col gap-4"
	classEyebrow  = "font-mono text-xs tracking-widest uppercase text-neutral-500 dark:text-neutral-400"
	classTitle    = "text-3xl font-semibold tracking-tight text-balance"
	classSubtitle = "text-lg font-semibold tracking-tight"
	classLead     = "max-w-xl text-neutral-500 dark:text-neutral-400"
	...
	classCard     = "flex flex-col gap-2 rounded-lg border border-neutral-200 bg-white p-4 dark:border-neutral-800 dark:bg-neutral-900"
	classCardHead = "flex items-baseline justify-between gap-3"
	classCardName = "font-semibold tracking-tight"
	classCardBody = "text-sm text-neutral-500 dark:text-neutral-400"
	...
	classLabel    = "basis-full text-sm font-medium"
	classInput    = "min-w-0 flex-1 rounded-md border border-neutral-200 bg-white px-2.5 py-2 dark:border-neutral-800 dark:bg-neutral-900"
	...
	classInputFull = "w-full rounded-md border border-neutral-200 bg-white px-2.5 py-2 dark:border-neutral-800 dark:bg-neutral-900"
	classButton   = "rounded-md bg-accent px-4 py-2 font-medium text-neutral-50 hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-50 dark:text-neutral-900"
	classHint     = "basis-full font-mono text-xs text-neutral-500 dark:text-neutral-400"
	classHintOver = "basis-full font-mono text-xs text-red-600 dark:text-red-400"
	classList     = "divide-y divide-neutral-200 overflow-hidden rounded-lg border border-neutral-200 bg-white dark:divide-neutral-800 dark:border-neutral-800 dark:bg-neutral-900"
	classItem     = "px-3 py-2.5"
	classEmpty    = "rounded-lg border border-dashed border-neutral-300 p-5 text-center text-neutral-500 dark:border-neutral-700 dark:text-neutral-400"
	classFlash    = "rounded-md border-l-[3px] border-accent bg-white px-3 py-2 dark:bg-neutral-900"
	classError    = "rounded-md border-l-[3px] border-red-600 bg-white px-3 py-2 text-red-600 dark:bg-neutral-900 dark:text-red-400"
